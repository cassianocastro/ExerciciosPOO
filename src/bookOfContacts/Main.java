...
public class PrimeiraAgenda {
    ...
    public static void main(String[] args) {
        int retorno;
        while ( true ) {
            retorno = JOptionPane.showOptionDialog(null, "Selecione a opção...", "Olá", 
                      JOptionPane.DEFAULT_OPTION,
                      JOptionPane.INFORMATION_MESSAGE,
                      null,
                      new String[] {"Add", "Exibir", "Remover", "Sair"},
                      null);
            switch ( retorno ){
                case 0:
                    escolher();
    ...
    private static void escolher(){
        String nome, endereco, telefone; int retorno;
        while ( true ){
            retorno = JOptionPane.showOptionDialog(null, "Tipo de Pessoa?", "Opção", 
                      JOptionPane.DEFAULT_OPTION,
                      JOptionPane.QUESTION_MESSAGE,
                      null,
                      new String[] {"Física", "Jurídica", "Voltar"},
                      null);
            switch ( retorno ){
                case 0:
                    ...
                    Pessoa_Fisica pessoa_f = new Pessoa_Fisica( nome, endereco, telefone, CPF, data_nasc, altura );
                    agenda.add( pessoa_f );
                    break;
                case 1:
                    nome              = JOptionPane.showInputDialog("Nome:");
                    ...
                    Pessoa_Juridica pessoa_j = new Pessoa_Juridica( nome, endereco, telefone, CNPJ, data_Found );
                    agenda.add( pessoa_j );
                    break;
                default:
                    return;
