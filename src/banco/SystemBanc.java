...
public class SystemBanc {
    ...
    public static void addConta() {
        ...
        int retorno = JOptionPane.showOptionDialog(null, "Escolha uma opção:", "Tipo",
    ...
    private static void menuOpcoes(Conta conta){
        int retorno; String valor;
        while ( true ) {
            retorno = JOptionPane.showOptionDialog(null, "Escolha a opção:", "Menu",
                      JOptionPane.DEFAULT_OPTION,
                      JOptionPane.QUESTION_MESSAGE,
                      null,
    ...
    public static void main(String[] args){
        int retorno; String senha;
        while ( true ){
            retorno = JOptionPane.showOptionDialog(null, "Seja bem-vindo.", "Olá",
                      JOptionPane.DEFAULT_OPTION,
                      JOptionPane.QUESTION_MESSAGE,
                      null,
                      new String[] {"Nova conta", "Já sou cliente", "Exibir Contas",
            ...
            switch ( retorno ){
                ...
                case 3:
                    senha = JOptionPane.showInputDialog("Senha da conta:");
                    JOptionPane.showMessageDialog(null, banco.remove(senha) ? "Conta encerrada." : "Conta não encontrada.");
                    break;
                case 4:
                    banco.corrigir();
